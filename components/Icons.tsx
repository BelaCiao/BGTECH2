...
export const IconPC = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect width="8" height="14" x="2" y="6" rx="2"></rect>
    <path d="M14 20h6a2 2 0 0 0 2-2V6a2 2 0 0 0-2-2h-6"></path>
...
export const IconMicrowave = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
    <rect width="20" height="15" x="2" y="5" rx="2"></rect>
    <path d="M18 12h0"></path>
    <path d="M18 16h0"></path>
    <path d="M18 8h0"></path>
    <path d="M6 12h8"></path>
  </svg>
);
